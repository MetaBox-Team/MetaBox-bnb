...
export interface DataBox {
  ...
  'getAllNftFile': ActorMethod<[], Array<FileExt>>,
  ...
  'isNftCollection': ActorMethod<[], boolean>,
  'isNftFile': ActorMethod<[Array<string>], Array<boolean>>,
  'memAlign': ActorMethod<[], undefined>,
  'mintNftCollection': ActorMethod<[], boolean>,
  'mintNftFile': ActorMethod<[Array<string>], Array<Result>>,
...
export type DataErr = { 'FilePrivate': null } |
  { 'FileKeyErr': null } |
  { 'FileNftMint': null } |
  { 'FilePublic': null } |
  { 'BlobSizeError': null } |
