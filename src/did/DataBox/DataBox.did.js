export const idlFactory = ({IDL}) => {
  const DataErr = IDL.Variant({
    'FilePrivate': IDL.Null,
    'FileKeyErr': IDL.Null,
    'FileNftMint': IDL.Null,
    'FilePublic': IDL.Null,
  ...
  const DataBox = IDL.Service({
    ...
    'getAllNftFile': IDL.Func([], [IDL.Vec(FileExt)], ['query']),
    ...
    'isNftCollection': IDL.Func([], [IDL.Bool], ['query']),
    'isNftFile': IDL.Func([IDL.Vec(IDL.Text)], [IDL.Vec(IDL.Bool)], ['query']),
    'memAlign': IDL.Func([], [], []),
    'mintNftCollection': IDL.Func([], [IDL.Bool], []),
    'mintNftFile': IDL.Func([IDL.Vec(IDL.Text)], [IDL.Vec(Result)], []),
